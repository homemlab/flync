...
class EBMPredictorWithScaler(EBMPredictor):
    ...
    **kwargs
    ...
    def predict(self, data, **kwargs):
        ...
        validated_data, validation_result = self._validate_and_prepare(data)
        ...
        # Use parent's predict with validated/scaled data
        return super().predict(validated_data, **kwargs)

    def predict_proba(self, data: pd.DataFrame, **kwargs):
        """Predict probabilities with optional scaling."""
        # Similar to predict but for probabilities
        should_validate = kwargs.get("validate", self.auto_validate)
        validated_data = data
        ...
        return super().predict_proba(validated_data, validate=False, **kwargs)
